...
public class DrawGetInElevator implements DrawCommand{
    
    private Elevator elevator;
    private Floor floor;
    private BuildingVisualization building;
    
    public DrawGetInElevator(Elevator elevator, Floor floor, BuildingVisualization building){
    ...
    @Override
    public void execute() {
        building.addPassengersOnFloor(floor.getLevel(), floor.getPassengers().size());
