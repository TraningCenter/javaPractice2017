package avilova.lift.app.ui;

import avilova.lift.app.Lift;
import avilova.lift.app.interfaces.IDisplayGraphics;
import avilova.lift.app.interfaces.IDisplayInfo;
...
public class ObjectOfGraphics implements IDisplayGraphics, IDisplayInfo {
     ...
     */
    public ObjectOfGraphics(Lift lift, int numberOfFloors, String[][] matr, Console console) {
        this.lift = lift;
    ...
    /**
     * очищает матрицу отрисовки от записей местонахождения лифта и движения
     * пассажиров
     */
