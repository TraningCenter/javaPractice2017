...
public class ControllerOfLift {
     ...
     * @param lift-лифт
     */
    public ControllerOfLift(Lift lift) {
        this.lift = lift;
     ...
     * изменение направления лифта если лифт изменил направление, то у всех
     * пассажиров поле isLater меняется на false
     *
    ...
    /**
     * нужно ли изменить направление лифта или нет меняем, если пассажиров в
     * лифте нет или если нет пассажиров, которым он подходит
     *
