...
public class ActionUp implements IAction {
     ...
     * @param lift-лифт
     */
    public ActionUp(Lift lift) {
        this.lift = lift;
    }

    /**
     * движение лифта, подходит для тех, кто движется вверх, сначала пассажиры
     ...
     * и лифт приедет за ним, но уже в следующий раз. Лифт опускается, если
     * пассажир находится ниже, чем лифт, иначе поднимается, если пассажир
     * находится выше лифта
     *
