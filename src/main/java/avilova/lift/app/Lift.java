...
public class Lift {
     ...
     * @param numberOfPassenger-колличество пассажиров, которые хотят
     * воспользоваться данным лифтом
     * @param number-номер лифта
     */
    public Lift(boolean rout, int location, int vol, int possibleInitialFloor, int possibleFinaleFloor, int numberOfPassenger, int number) {
        this.rout = rout;
