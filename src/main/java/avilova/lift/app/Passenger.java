...
public class Passenger {
     ...
     */
    public Passenger(int possibleInitialFloor, int possibleFinaleFloor) {
    ...
    /**
     * меняет probabilityOfEnter-вероятность захода пассажира, если раньше, это
     * значение было меньше BorderOfProbability и возвращает ответ, подходит ли
     * лифт пассажиру или нет
     *
