...
import com.netcracker.unc.commands.elevator.UnLoadElevatorCommand;
...
public class CommandsTests {
    ...
    public void UnLoadPassengersElevatorCommand() {
        ...
        UnLoadElevatorCommand command = new UnLoadElevatorCommand(elevator);
        command.execute();
    ...
    public void LoadPassengersElevatorCommand() {
        ...
        LoadPassengersElevatorCommand command = new LoadPassengersElevatorCommand(elevator, floor);
        command.execute();
    ...
    @Test
    public void MoveElevatorCommandAndStopElevatorCommand() {
    ...
    public void CallElevatorBuildingCommand() {
        ...
        new CallElevatorBuildingCommand(elevators, floor, passenger.getDirection()).execute();
